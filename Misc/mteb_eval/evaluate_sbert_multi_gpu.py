...
parser.add_argument('--attention', type=str, help='attention', default='causal')
parser.add_argument('--attn_implementation', type=str, help='eager/sdpa/flash_attention_2', default='flash_attention_2')
...
if __name__ == "__main__":
    ...
    corpus, queries, qrels = HFDataLoader(data_folder=dataset_path, streaming=False).load(split=[args.split])
    ...
    model = DRPES(
        beir_model, batch_size=batch_size, 
        corpus_chunk_size=corpus_chunk_size)
    
    retriever = EvaluateRetrieval(
        model, k_values=[1,3,5,10,30,100], score_function="dot")
