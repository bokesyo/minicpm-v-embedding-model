...
class DataArguments:
    ...
    # tokenization: Optional[bool] = field(
    #     default=True, # can be False -> don't tokenize in Trainer, so q_max_len and q_max_len are useless ans should be disabled
    #     metadata={"help": "Whether to tokenize the data in `Trainer` or not, if False, model should handle tokenize."},
    # )
